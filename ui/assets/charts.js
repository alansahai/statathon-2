...
const ChartService = {
    /**
     * Base URL for API (matches api.js)
     */
    ...
    loadChartImage(path, elementId, options = {}) {
        ...
        const fullUrl = `${this.API_BASE}/${cleanPath}`;
    ...
    createChartGallery(charts, containerId) {
        ...
        const tabContents = chartTypes.map((type, index) => `
            <div class="tab-content ${index === 0 ? 'active' : ''}" 
                 id="content-${type}">
                <img src="${this.API_BASE}/${charts[type]}" 
    ...
    downloadChart(chartPath, filename = 'chart.png') {
        const fullUrl = `${this.API_BASE}/${chartPath}`;
    ...
    addDownloadButton(chartId, chartPath, filename = 'chart.png') {
        ...
        button.innerHTML = '📥 Download Chart';
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('✅ charts.js loaded - Chart service ready');
});
